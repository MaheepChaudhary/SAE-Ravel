...
python3.11 main.py -a country -tla 61 -method "neuron masking" -e 20 -t train -idd "country" -bs 16 -wb "True" -n "t(10-0.1)_lr0.001_layer-5" -lr "0.001" -lid 5 -d "mps"
python3.11 main.py -a continent -tla 61 -method "neuron masking" -e 20 -t train -idd "continent" -bs 16 -wb "True" -n "t(10-0.1)_lr0.001_layer-5" -lr "0.001" -lid 5 -d "mps"
